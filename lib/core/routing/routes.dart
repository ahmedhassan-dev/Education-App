class AppRoutes {
  ...
  static const String selectUserTypeRoute = '/select-user';
  static const String selectEducationalStagesRoute = '/select-stage';
  ...
  static const String checkAnswersRoute = '/check-answers';
